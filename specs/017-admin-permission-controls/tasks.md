...
- [ ] T001 Create permission catalog skeleton in `src/lib/permissions/catalog.ts`
...
- [ ] T002 [P] Create permission evaluator test file in `tests/unit/permission-evaluator.test.ts`
...
- [ ] T003 [P] Create integration test files in `tests/integration/admin-permissions.test.ts` and `tests/integration/manager-permission-enforcement.test.ts`
...
- [ ] T004 Add Prisma models and migration for permission settings in `prisma/schema.prisma` and `prisma/migrations/`
...
- [ ] T005 Implement permission evaluator in `src/lib/permissions/evaluator.ts`
...
- [ ] T006 Implement audit writer in `src/lib/permissions/audit.ts`
...
- [ ] T007 Add API guard helpers in `src/lib/auth-utils.ts` or `src/lib/permissions/guards.ts`
...
- [ ] T008 [P] [US1] Add global freeze API tests in `tests/integration/admin-permissions.test.ts`
...
- [ ] T009 [US1] Add global permission settings routes under `src/app/api/admin/permissions/global/`
...
- [ ] T010 [US1] Enforce freeze in admin user creation route `src/app/api/admin/users/route.ts`
...
- [ ] T011 [US1] Enforce freeze in manager user creation route `src/app/api/manager/users/route.ts`
...
- [ ] T012 [US1] Disable or hide admin create buttons in `src/components/admin/users/UsersTable.tsx`
...
- [ ] T013 [US1] Disable manager create button in `src/components/manager/ManagerPageContent.tsx`
...
- [ ] T014 [P] [US2] Add role permission API tests in `tests/integration/admin-permissions.test.ts`
...
- [ ] T015 [US2] Add role permission routes under `src/app/api/admin/permissions/roles/`
...
- [ ] T016 [US2] Enforce manager create permission in `src/app/api/manager/users/route.ts`
...
- [ ] T017 [US2] Enforce manager balance add/withdraw permissions in `src/app/api/manager/users/[id]/balance/route.ts`
...
- [ ] T018 [US2] Add admin permission management UI in `src/components/admin/permissions/`
...
- [ ] T019 [P] [US3] Add user override tests in `tests/integration/admin-permissions.test.ts`
...
- [ ] T020 [US3] Add user override routes under `src/app/api/admin/permissions/users/`
...
- [ ] T021 [US3] Add user override UI in `src/components/admin/permissions/`
...
- [ ] T024 [US4] Implement protected admin checks in `src/lib/permissions/protected-admin.ts`
...
- [ ] T025 [US4] Add permission audit views in admin permissions UI
...
- [ ] T026 Run focused verification commands
...
- [ ] T027 Update deployment notes and production safety checklist
