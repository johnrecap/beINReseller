...
interface ManagerAddBalanceDialogProps {
    isOpen: boolean
    onClose: () => void
    onSuccess: () => void
    userId: string | null
...
export default function ManagerAddBalanceDialog({ 
    isOpen, 
    onClose, 
    onSuccess, 
    userId, 
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const res = await fetch(`/api/manager/users/${userId}/balance`, {
                method: 'PATCH',
                ...
                <form onSubmit={handleSubmit} className="p-4 space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            min="0.01"
                            step="0.01"
                            max={isDeposit ? managerBalance : undefined}
                            required
                            autoFocus
