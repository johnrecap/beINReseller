export const ar = {
    ...
    mobileApp: {
        ...
        subscriptions: {
            title: 'الاشتراكات',
            subtitle: 'عمليات التجديد وتجديد الإشارة',
            operationsLog: 'سجل العمليات',
            showingOperations: 'عرض {count} من {total} عملية',
            noOperations: 'لا توجد عمليات',
            date: 'التاريخ',
            customer: 'العميل',
            type: 'النوع',
            ...
            pending: 'في الانتظار',
            processing: 'قيد المعالجة',
            awaitingPackage: 'بانتظار الباقة',
            completed: 'مكتمل',
            failed: 'فاشل',
            // أنواع
            renew: 'تجديد',
            signalRefresh: 'تجديد إشارة',
            checkBalance: 'فحص الرصيد'
        },
        // صفحة الإعدادات
        settings: {
            title: 'إعدادات التطبيق',
            subtitle: 'تكوين إعدادات تطبيق الموبايل',
            saveSettings: 'حفظ الإعدادات',
            // حالة التطبيق
            appStatus: 'حالة التطبيق',
            appStatusDescription: 'التحكم في تشغيل وإيقاف التطبيق',
            enableApp: 'تفعيل التطبيق',
            appEnabled: 'التطبيق يعمل بشكل طبيعي',
            appDisabled: 'التطبيق معطل',
            maintenanceMode: 'وضع الصيانة',
            maintenanceEnabled: 'التطبيق في وضع الصيانة',
            maintenanceDisabled: 'التطبيق يعمل بشكل عادي',
            appVersion: 'إصدار التطبيق',
            currentVersion: 'الإصدار الحالي المطلوب',
            // المحفظة
            walletSettings: 'إعدادات المحفظة',
            walletLimits: 'حدود شحن المحفظة',
            minTopup: 'الحد الأدنى للشحن',
            maxTopup: 'الحد الأقصى للشحن',
            minGreaterThanMax: 'الحد الأدنى أكبر من الحد الأقصى',
            // الاشتراكات
            subscriptionSettings: 'إعدادات الاشتراكات',
            profitAndPricing: 'نسبة الربح وأسعار الخدمات',
            markupPercent: 'نسبة الربح على الاشتراكات (%)',
            markupDescription: 'سيتم إضافة هذه النسبة على أسعار beIN الأصلية',
            signalRefreshPrice: 'سعر تجديد الإشارة',
            // الشحن
            shippingSettings: 'إعدادات الشحن',
            shippingByCountry: 'تكاليف الشحن حسب البلد'
        },
        // صفحة المدفوعات
        payments: {
            title: 'المدفوعات',
            subtitle: 'مدفوعات شحن المحفظة عبر Stripe',
            exportCSV: 'تصدير CSV',
        ...
        customers: {
            title: 'عملاء التطبيق',
            subtitle: 'إدارة عملاء تطبيق الموبايل',
            searchPlaceholder: 'بحث بالاسم أو البريد...',
            totalCustomers: 'إجمالي العملاء',
            customersList: 'قائمة العملاء',
            showingCustomers: 'عرض {count} من {total} عميل',
