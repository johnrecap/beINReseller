export const bn = {
    common: {
        welcome: 'Desh Panel',
        transferOwner: 'ব্যবহারকারীর মালিকানা স্থানান্তর',
        targetType: 'নতুন মালিকের ধরন',
        targetOwner: 'নতুন মালিক',
        selectOwner: 'একজন মালিক নির্বাচন করুন',
        noTransferTargets: 'কোনো উপযুক্ত মালিক নেই',
        ownerAdmin: 'অ্যাডমিন',
        ownerManager: 'ম্যানেজার',
        ownerAgent: 'এজেন্ট',
        sourceGroupLabel: 'Source Group',
        whatsappGroupLinkLabel: 'WhatsApp গ্রুপ লিংক',
        transferReason: 'স্থানান্তরের কারণ',
        optionalNote: 'ঐচ্ছিক নোট',
        transferAction: 'মালিকানা স্থানান্তর করুন',
        loadTransferTargetsFailed: 'স্থানান্তরের লক্ষ্যগুলো লোড করা যায়নি। আবার চেষ্টা করুন।',
        transferOwnershipFailed: 'মালিকানা স্থানান্তর করা যায়নি। আবার চেষ্টা করুন।',
        invalidWhatsappGroupLink: 'একটি বৈধ WhatsApp গ্রুপ লিংক লিখুন।',
        openLink: 'লিংক খুলুন',
        login: 'লগইন',
        logout: 'লগআউট',
        ...
        noData: 'কোন তথ্য নেই',
        allGroups: 'সব গ্রুপ',
        withoutGroup: 'গ্রুপ ছাড়া',
        ownershipChanged: 'মালিকানা পরিবর্তিত হয়েছে। ডেটা রিফ্রেশ করে আবার নিশ্চিত করুন। স্থানান্তরটি স্বয়ংক্রিয়ভাবে পুনরায় চেষ্টা করা হয়নি।',
        refreshAndReconfirm: 'রিফ্রেশ করে আবার নিশ্চিত করুন',
        transferPreservesAccountData: 'শুধু মালিকানা পরিবর্তিত হবে। ব্যালেন্স, ঋণ, অপারেশন, লেনদেন, পয়েন্ট ও ইতিহাস অপরিবর্তিত থাকবে।',
        agentDefaultSourceGroupHint: 'একই এজেন্টের জন্য অপরিবর্তিত রাখলে বর্তমান মান থাকবে; নতুন এজেন্টের ক্ষেত্রে দেখানো ডিফল্ট সার্ভার নির্ধারণ করবে। গ্রুপ ছাড়া রাখতে সম্পাদনা করে খালি করুন।',
        whatsappAssignmentHint: 'এই লিংক Source Group থেকে স্বাধীন। একই এজেন্টের জন্য অপরিবর্তিত রাখলে বর্তমান লিংক থাকবে; মুছতে সম্পাদনা করে খালি করুন। নতুন এজেন্ট আগের লিংক পাবে না।',
        clearSavedWhatsappLink: 'সংরক্ষিত WhatsApp লিংক মুছুন',
        status: 'অবস্থা',
        date: 'তারিখ',
        actions: 'কর্ম',
        close: 'বন্ধ করুন',
    ...
    passwordReset: {
        ...
        title: 'ব্যবহারকারীর পাসওয়ার্ড রিসেট',
        description: 'নতুন পাসওয়ার্ড নির্ধারণ করুন',
        ...
        sessionWarning: 'এই ব্যবহারকারীর সব বর্তমান সেশন থেকে সাইন আউট হবে।',
        submit: 'পাসওয়ার্ড রিসেট',
        submitting: 'রিসেট হচ্ছে...',
        success: 'পাসওয়ার্ড রিসেট হয়েছে। ব্যবহারকারী নতুন পাসওয়ার্ড দিয়ে সাইন ইন করতে পারবেন।',
        forgotPasswordContactSupervisor: 'পাসওয়ার্ড ভুলে গেছেন? আপনার অ্যাকাউন্টের দায়িত্বে থাকা সুপারভাইজারের সাথে যোগাযোগ করুন।',
        strength: {
            minimum: 'কমপক্ষে ৬ অক্ষর',
            uppercase: 'বড় হাতের অক্ষর আছে',
            lowercase: 'ছোট হাতের অক্ষর আছে',
            number: 'সংখ্যা আছে',
        },
        errors: {
            INVALID_PASSWORD: 'কমপক্ষে ৬ অক্ষরের একটি বৈধ পাসওয়ার্ড লিখুন।',
            PERMISSION_DENIED: 'এই পাসওয়ার্ড রিসেট করার অনুমতি আপনার নেই।',
            PASSWORD_RESET_NOT_ALLOWED: 'আপনার ভূমিকা থেকে এই অ্যাকাউন্ট রিসেট করা যায় না।',
            TARGET_USER_NOT_FOUND: 'সক্রিয় ব্যবহারকারী অ্যাকাউন্টটি পাওয়া যায়নি।',
            OWNERSHIP_CONFLICT: 'ব্যবহারকারীর মালিকানা বদলেছে বা বিরোধ আছে। তালিকা রিফ্রেশ করে আবার চেষ্টা করুন।',
            RATE_LIMITED: 'এই ব্যবহারকারীর জন্য অনেকবার চেষ্টা হয়েছে। পরে আবার চেষ্টা করুন।',
            SERVER_ERROR: 'পাসওয়ার্ড রিসেট করা যায়নি। আবার চেষ্টা করুন।',
        },
    },
    sidebar: {
    ...
    userStats: {
        ...
        netSpending: {
            title: 'নিট ব্যয়',
            subtitle: 'কর্তন - ফেরত',
            completedTitle: 'সম্পন্ন অপারেশন ব্যয়',
            completedSubtitle: 'শুধুমাত্র সম্পন্ন অপারেশন কর্তন'
        },
        refundSummary: {
            title: 'ফেরত সমস্যার সারসংক্ষেপ',
            doubleRefund: 'ডাবল ফেরত',
            doubleRefundDesc: 'একই অপারেশন ২+ বার',
            phantomRefund: 'ভুয়া ফেরত',
            phantomRefundDesc: 'পূর্ব কর্তন ছাড়াই',
            overRefund: 'অতিরিক্ত ফেরত',
            overRefundDesc: 'কর্তনের চেয়ে বেশি'
        }
    },
    admin: {
        pointsSettings: {
            programEnabledHelp: '\u09ac\u09a8\u09cd\u09a7 \u09a5\u09be\u0995\u09b2\u09c7, \u0996\u09b0\u099a-\u09ad\u09bf\u09a4\u09cd\u09a4\u09bf\u0995 \u0985\u09aa\u09be\u09b0\u09c7\u09b6\u09a8 \u09aa\u09df\u09c7\u09a8\u09cd\u099f \u09a6\u09c7\u0993\u09df\u09be \u09b9\u09ac\u09c7 \u09a8\u09be.',
            managerOwnedUserToggleHelp: '\u09ae\u09cd\u09af\u09be\u09a8\u09c7\u099c\u09be\u09b0\u09c7\u09b0 \u0985\u09a7\u09c0\u09a8\u09c7 \u09a5\u09be\u0995\u09be \u09ac\u09cd\u09af\u09ac\u09b9\u09be\u09b0\u0995\u09be\u09b0\u09c0\u09b0\u09be \u09ae\u09cd\u09af\u09be\u09a8\u09c7\u099c\u09be\u09b0 \u09aa\u09df\u09c7\u09a8\u09cd\u099f\u09c7\u09b0 \u09aa\u09be\u09b6\u09be\u09aa\u09be\u09b6\u09bf \u09a8\u09bf\u099c\u09c7\u09a6\u09c7\u09b0 \u09aa\u09df\u09c7\u09a8\u09cd\u099f \u09aa\u09be\u09ac\u09c7 \u0995\u09bf \u09a8\u09be \u09a4\u09be \u09a8\u09bf\u09df\u09a8\u09cd\u09a4\u09cd\u09b0\u09a3 \u0995\u09b0\u09c7.',
            normalUserRateHelp: '\u098f\u099c\u09c7\u09a8\u09cd\u099f\u09c7\u09b0 \u0985\u09a7\u09c0\u09a8\u09c7 \u09a5\u09be\u0995\u09be \u098f\u09ac\u0982 \u09b8\u09b0\u09be\u09b8\u09b0\u09bf \u0985\u09cd\u09af\u09be\u09a1\u09ae\u09bf\u09a8\u09c7\u09b0 \u0985\u09a7\u09c0\u09a8\u09c7 \u09a5\u09be\u0995\u09be \u09ac\u09cd\u09af\u09ac\u09b9\u09be\u09b0\u0995\u09be\u09b0\u09c0\u09a6\u09c7\u09b0 \u0995\u09cd\u09b7\u09c7\u09a4\u09cd\u09b0\u09c7 \u09aa\u09cd\u09b0\u09af\u09cb\u099c\u09cd\u09af.',
            managerOwnedUserRateHelp: '\u09b6\u09c1\u09a7\u09c1 \u09ae\u09cd\u09af\u09be\u09a8\u09c7\u099c\u09be\u09b0\u09c7\u09b0 \u0985\u09a7\u09c0\u09a8\u09c7 \u09a5\u09be\u0995\u09be \u09ac\u09cd\u09af\u09ac\u09b9\u09be\u09b0\u0995\u09be\u09b0\u09c0\u09b0 \u09aa\u09df\u09c7\u09a8\u09cd\u099f \u099a\u09be\u09b2\u09c1 \u09a5\u09be\u0995\u09b2\u09c7 \u09ac\u09cd\u09af\u09ac\u09b9\u09be\u09b0 \u0995\u09b0\u09be \u09b9\u09df.',
            agentRateHelp: '\u09a8\u09bf\u099a\u09c7 \u09aa\u09cd\u09b0\u09a4\u09bf\u099f\u09bf \u098f\u099c\u09c7\u09a8\u09cd\u099f\u09c7\u09b0 \u099c\u09a8\u09cd\u09af \u0986\u09b2\u09be\u09a6\u09be \u09b9\u09be\u09b0 \u09a6\u09c7\u0993\u09df\u09be \u09af\u09be\u09df.',
            managerRateHelp: '\u09a8\u09bf\u099a\u09c7 \u09aa\u09cd\u09b0\u09a4\u09bf\u099f\u09bf \u09ae\u09cd\u09af\u09be\u09a8\u09c7\u099c\u09be\u09b0\u09c7\u09b0 \u099c\u09a8\u09cd\u09af \u0986\u09b2\u09be\u09a6\u09be \u09b9\u09be\u09b0 \u09a6\u09c7\u0993\u09df\u09be \u09af\u09be\u09df.',
        },
        dashboard: {
        ...
        config: {
            sections: {
                ...
                userProxySettings: 'সংবেদনশীল সিস্টেম সেটিংস',
                sessionRenewal: 'সেশন পুনর্নবীকরণ সেটিংস'
            },
            fields: {
                email: 'ইমেইল',
                password: 'পাসওয়ার্ড',
                ...
                userProxyLimit: 'অভ্যন্তরীণ সিস্টেম বিতরণ সীমা',
                keepaliveInterval: 'সেশন পুনর্নবীকরণ ব্যবধান (মিনিট)'
            },
            hints: {
                ...
                userProxyLimit: '⚠️ সতর্কতা: প্রযুক্তিগত সহায়তার সাথে যোগাযোগ না করে এই মানটি পরিবর্তন করবেন না। এই মান পরিবর্তন করলে সম্পূর্ণ সিস্টেমের কার্যকারিতা প্রভাবিত হতে পারে।',
                keepaliveInterval: 'সেশন পুনর্নবীকরণের মধ্যে কত মিনিট। ডিফল্ট 19 মিনিট। 25 মিনিটের (সেশন বৈধতা) কম হতে হবে।'
            },
            actions: {
        ...
        settings: {
            ...
            fields: {
                ...
                beinConnectionMode: 'beIN connection mode',
                beinConnectionModeHelp: 'Choose how new beIN operations connect. Existing operations keep the route they started with.',
                beinAssignedProxyMode: 'Use assigned proxies',
                beinAssignedProxyModeHelp: 'Normal mode. Accounts use their saved proxy when one is assigned.',
                beinServerIpMode: 'Emergency: use server IP',
                beinServerIpModeHelp: 'Temporary mode. New beIN actions ignore saved proxies and connect from the server IP.',
                beinConnectionModeWarning: 'Saved account proxy assignments are kept unchanged when emergency mode is enabled.',
    ...
    announcements: {
        title: 'ঘোষণা',
        subtitle: 'ড্যাশবোর্ডে ঘোষণা ব্যানার পরিচালনা করুন',
        newAnnouncement: 'নতুন ঘোষণা',
        editAnnouncement: 'ঘোষণা সম্পাদনা',
        message: 'ঘোষণার টেক্সট',
        messagePlaceholder: 'এখানে আপনার ঘোষণা লিখুন...',
        characters: 'অক্ষর',
        animationType: 'অ্যানিমেশন ধরন',
        ...
        marquee: 'মার্কি',
        none: 'কিছুই না',
        gradientColors: 'গ্রেডিয়েন্ট রং',
        ...
        floating: 'ভাসমান',
        active: 'সক্রিয়',
        dismissable: 'বাতিলযোগ্য',
        startDate: 'শুরুর তারিখ (ঐচ্ছিক)',
        endDate: 'শেষ তারিখ (ঐচ্ছিক)',
        preview: 'প্রিভিউ',
        previewPlaceholder: 'ঘোষণার টেক্সট এখানে দেখা যাবে...',
        save: 'সংরক্ষণ',
        cancel: 'বাতিল',
        currentAnnouncements: 'বর্তমান ঘোষণা',
        noAnnouncements: 'বর্তমানে কোনো ঘোষণা নেই',
        activate: 'সক্রিয় করুন',
        deactivate: 'নিষ্ক্রিয় করুন',
        edit: 'সম্পাদনা',
        delete: 'মুছুন',
        confirmDelete: 'আপনি কি নিশ্চিত এই ঘোষণা মুছতে চান?',
        created: 'ঘোষণা তৈরি হয়েছে',
        updated: 'ঘোষণা আপডেট হয়েছে',
        deleted: 'ঘোষণা মুছে ফেলা হয়েছে',
        statusUpdated: 'ঘোষণার স্থিতি আপডেট হয়েছে',
        failedToLoad: 'ঘোষণা লোড করতে ব্যর্থ',
        failedToSave: 'ঘোষণা সংরক্ষণ করতে ব্যর্থ',
        failedToDelete: 'ঘোষণা মুছতে ব্যর্থ',
        failedToUpdate: 'স্থিতি আপডেট করতে ব্যর্থ',
        enterMessage: 'অনুগ্রহ করে ঘোষণার টেক্সট লিখুন'
    },

    // কিস্তি
    installment: {
        title: 'মাসিক কিস্তি পরিশোধ',
        description: 'বকেয়া কিস্তি পরীক্ষা করতে beIN কার্ড নম্বর লিখুন',
        cardLabel: 'কার্ড নম্বর',
        cardError: 'কার্ড নম্বর কমপক্ষে ১০ সংখ্যার হতে হবে',
        loadButton: 'কিস্তির তথ্য লোড করুন',
        loadingTitle: 'প্রক্রিয়াকরণ হচ্ছে...',
        loadingDescription: 'beIN-এর সাথে সংযোগ করে কিস্তির তথ্য বের করা হচ্ছে',
        confirmTitle: 'চূড়ান্ত পেমেন্ট নিশ্চিতকরণ',
        confirmMessage: 'ক্রয় সম্পন্ন করার আগে এটি শেষ ধাপ',
        packageLabel: 'প্যাকেজ',
        notSpecified: 'নির্দিষ্ট নয়',
        priceLabel: 'মূল্য',
        stbLabel: 'রিসিভার নম্বর',
        cardLabelShort: 'কার্ড নম্বর',
        yourBalance: 'আপনার ব্যালেন্স',
        insufficientBalance: 'অপর্যাপ্ত ব্যালেন্স',
        expiryWarning: '⚠️ ১০ সেকেন্ডের মধ্যে সময় শেষ হবে!',
        cancel: 'বাতিল',
        confirming: 'নিশ্চিত করা হচ্ছে...',
        payNow: 'পেমেন্ট নিশ্চিত করুন',
        success: 'কিস্তি সফলভাবে পরিশোধ হয়েছে',
        failed: 'অপারেশন ব্যর্থ হয়েছে',
        existingOperation: 'এই কার্ডের জন্য একটি চলমান অপারেশন আছে',
        goToOperations: 'অপারেশনে যান',
        startFailed: 'অপারেশন শুরু করতে ব্যর্থ',
        loadingInstallment: 'কিস্তির তথ্য লোড হচ্ছে...',
        confirmFailed: 'পেমেন্ট নিশ্চিত করতে ব্যর্থ',
        processingPayment: 'পেমেন্ট প্রসেস হচ্ছে...',
        expiredCancel: 'সময় শেষ হওয়ায় অপারেশন বাতিল হয়েছে',
        manualCancel: 'অপারেশন বাতিল হয়েছে',
        continueToPayment: 'পেমেন্টে চালিয়ে যান',
        confirmingTitle: 'পেমেন্ট নিশ্চিত করা হচ্ছে...',
        confirmingDescription: 'beIN-তে পেমেন্ট সম্পন্ন করা হচ্ছে',
        successTitle: 'পেমেন্ট সফল!',
        successMessage: 'কিস্তি সফলভাবে পরিশোধ হয়েছে',
        newOperation: 'নতুন অপারেশন',
        noInstallmentTitle: 'কোনো কিস্তি নেই',
        noInstallmentMessage: 'এই কার্ডের জন্য কোনো বকেয়া কিস্তি নেই',
        tryAnother: 'অন্য কার্ড চেষ্টা করুন',
        errorTitle: 'অপারেশন ব্যর্থ',
        tryAgain: 'আবার চেষ্টা করুন',
        contractInfo: 'চুক্তির তথ্য',
        subscriberInfo: 'গ্রাহকের তথ্য',
        subscriberName: 'গ্রাহকের নাম',
        subscriberEmail: 'গ্রাহকের ইমেইল',
        mobile: 'মোবাইল',
        city: 'শহর',
        country: 'দেশ',
        homeTel: 'বাসার ফোন',
        ...
        address: 'ঠিকানা',
        remarks: 'মন্তব্য',
        monthsToPay: 'পরিশোধের মাস',
        installmentAmount: 'কিস্তির পরিমাণ',
        contractStartDate: 'চুক্তি শুরুর তারিখ',
        contractExpiryDate: 'চুক্তি শেষের তারিখ',
        invoicePrice: 'ইনভয়েস মূল্য (USD)',
        dealerPrice: 'ডিলার মূল্য (USD)',
        payInstallment: 'কিস্তি পরিশোধ করুন'
    },

    // কার্যকলাপ
    activity: {
        title: 'ব্যবহারকারী কার্যকলাপ মনিটরিং',
        subtitle: 'কার্যকলাপ ট্র্যাক করুন এবং নিষ্ক্রিয় অ্যাকাউন্ট চিহ্নিত করুন',
        tabs: {
        ...
        table: {
            ...
            logins: 'লগইন:',
            operations: 'অপস:',
            neverLoggedIn: 'কখনো লগইন করেনি',
            noInactiveUsers: 'কোনো নিষ্ক্রিয় ব্যবহারকারী পাওয়া যায়নি'
        },
        filters: {
            searchPlaceholder: 'নাম বা ইমেইলে অনুসন্ধান...',
            allRoles: 'সব ভূমিকা',
            inactiveSince: 'নিষ্ক্রিয় সময়',
