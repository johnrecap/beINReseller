export const bn = {
    ...
    mobileApp: {
        ...
        subscriptions: {
            title: 'সাবস্ক্রিপশন',
            subtitle: 'রিনিউয়াল এবং সিগন্যাল রিফ্রেশ অপারেশন',
            operationsLog: 'অপারেশন লগ',
            showingOperations: '{total} টির মধ্যে {count} টি অপারেশন দেখানো হচ্ছে',
            noOperations: 'কোনো অপারেশন নেই',
            date: 'তারিখ',
            customer: 'গ্রাহক',
            type: 'ধরন',
            cardNumber: 'কার্ড নম্বর',
            ...
            pending: 'অপেক্ষমাণ',
            processing: 'প্রক্রিয়াধীন',
            awaitingPackage: 'প্যাকেজের অপেক্ষায়',
            completed: 'সম্পন্ন',
            failed: 'ব্যর্থ',
            renew: 'রিনিউ',
            signalRefresh: 'সিগন্যাল রিফ্রেশ',
        ...
        settings: {
            title: 'অ্যাপ সেটিংস',
            subtitle: 'মোবাইল অ্যাপ সেটিংস কনফিগার করুন',
            saveSettings: 'সেটিংস সংরক্ষণ',
            appStatus: 'অ্যাপ অবস্থা',
            appStatusDescription: 'অ্যাপ চালু/বন্ধ নিয়ন্ত্রণ',
            enableApp: 'অ্যাপ সক্রিয় করুন',
            appEnabled: 'অ্যাপ স্বাভাবিকভাবে চলছে',
            appDisabled: 'অ্যাপ নিষ্ক্রিয়',
            maintenanceMode: 'মেইনটেন্যান্স মোড',
            maintenanceEnabled: 'অ্যাপ মেইনটেন্যান্স মোডে আছে',
            maintenanceDisabled: 'অ্যাপ স্বাভাবিকভাবে চলছে',
            appVersion: 'অ্যাপ ভার্সন',
            currentVersion: 'বর্তমান প্রয়োজনীয় ভার্সন',
            walletSettings: 'ওয়ালেট সেটিংস',
            walletLimits: 'ওয়ালেট টপ-আপ সীমা',
            minTopup: 'সর্বনিম্ন টপ-আপ',
            maxTopup: 'সর্বোচ্চ টপ-আপ',
            minGreaterThanMax: 'সর্বনিম্ন সর্বোচ্চের চেয়ে বেশি',
            subscriptionSettings: 'সাবস্ক্রিপশন সেটিংস',
            profitAndPricing: 'লাভের শতাংশ এবং সেবা মূল্য',
            markupPercent: 'সাবস্ক্রিপশন মার্কআপ (%)',
            markupDescription: 'এই শতাংশ beIN মূল দামের উপরে যোগ হবে',
            signalRefreshPrice: 'সিগন্যাল রিফ্রেশ মূল্য',
            shippingSettings: 'শিপিং সেটিংস',
            shippingByCountry: 'দেশ অনুযায়ী শিপিং খরচ'
        },
        payments: {
            title: 'পেমেন্ট',
            subtitle: 'Stripe এর মাধ্যমে ওয়ালেট টপ-আপ পেমেন্ট',
            exportCSV: 'CSV এক্সপোর্ট',
            paymentsLog: 'পেমেন্ট লগ',
            showingPayments: '{total} টির মধ্যে {count} টি পেমেন্ট দেখানো হচ্ছে',
        ...
        orders: {
            title: 'অর্ডার',
            subtitle: 'স্টোর অর্ডার পরিচালনা',
            ordersList: 'অর্ডার তালিকা',
            showingOrders: '{total} টির মধ্যে {count} টি অর্ডার দেখানো হচ্ছে',
            ...
            productsCount: 'পণ্য ({count})',
            quantity: 'পরিমাণ',
            orderTimeline: 'অর্ডার টাইমলাইন',
            createdDate: 'তৈরির তারিখ',
            paidDate: 'পেমেন্ট তারিখ',
            processedDate: 'প্রসেসের তারিখ',
            shippedDate: 'শিপের তারিখ',
            deliveredDate: 'ডেলিভারির তারিখ',
            ...
            notes: 'নোট',
            enterTracking: 'ট্র্যাকিং নম্বর লিখুন'
        },
        customers: {
            title: 'অ্যাপ গ্রাহক',
            subtitle: 'মোবাইল অ্যাপ গ্রাহক পরিচালনা',
            searchPlaceholder: 'নাম বা ইমেইলে অনুসন্ধান...',
            totalCustomers: 'মোট গ্রাহক',
            customersList: 'গ্রাহক তালিকা',
            showingCustomers: '{total} জনের মধ্যে {count} জন গ্রাহক দেখানো হচ্ছে',
            ...
            amountLabel: 'পরিমাণ',
            reason: 'কারণ (ঐচ্ছিক)',
            adjusting: 'সমন্বয় হচ্ছে...',
            walletTab: 'ওয়ালেট',
            operationsTab: 'অপারেশন',
            ordersTab: 'অর্ডার',
            noTransactions: 'কোনো লেনদেন নেই',
            noOperations: 'কোনো অপারেশন নেই',
            noOrders: 'কোনো অর্ডার নেই',
            manualAdjust: 'ম্যানুয়াল সমন্বয়'
        }
    },
